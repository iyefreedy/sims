...
mixin _$Course {
  ...
  @JsonKey(name: 'nama_mata_pelajaran')
  String get name => throw _privateConstructorUsedError;
  @JsonKey(name: 'kode_mata_pelajaran')
...
abstract class $CourseCopyWith<$Res> {
  ...
  $Res call(
      {String id,
      @JsonKey(name: 'nama_mata_pelajaran') String name,
      @JsonKey(name: 'kode_mata_pelajaran') String code});
}
...
class _$_Course implements _Course {
  _$_Course(
      {required this.id,
      @JsonKey(name: 'nama_mata_pelajaran') required this.name,
      @JsonKey(name: 'kode_mata_pelajaran') required this.code});
...
abstract class _Course implements Course {
  factory _Course(
          ...
          @JsonKey(name: 'nama_mata_pelajaran') required final String name,
          @JsonKey(name: 'kode_mata_pelajaran') required final String code}) =
      _$_Course;
